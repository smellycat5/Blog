                    ...
                    <form action="{{ route('blog.store') }}" method="POST">
                        ...
                        <div class="mt-4">
                            ...
                            <input type="text" name="title" id="title"
                                class="border border-gray-300 rounded-lg px-4 py-2 mt-1 w-full" required>
                        </div>

                        <div class="mt-4">
                            <label for="content" class="block font-semibold">Content:</label>
                            <textarea name="content" id="content" class="border border-gray-300 rounded-lg px-4 py-2 mt-1 w-full" rows="6"></textarea>
                        </div>
